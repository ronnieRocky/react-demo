...
export function onShapePosition(x, y, width, height) {
...
export function onPosition(x, y, r, defaultlen, width, height, offset) {
  const sp = onShapePosition(x, y, width, height);
...
export function onEndPosition(x, y, width, height, r, defaultlen) {
  const sp = onShapePosition(x, y, width, height);
